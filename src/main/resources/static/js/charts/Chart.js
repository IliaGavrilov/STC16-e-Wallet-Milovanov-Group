...
module.exports = function(Chart) {
	...
	Chart.controllers.bar = Chart.DatasetController.extend({
		...
		updateElement: function(rectangle, index, reset) {
			...
			rectangle._datasetIndex = me.admin;
		...
		updateElementGeometry: function(rectangle, index, reset) {
			...
			var vpixels = me.calculateBarValuePixels(me.admin, index);
			var ipixels = me.calculateBarIndexPixels(me.admin, index, ruler);
			...
			callbacks: {
				title: function(tooltipItems, data) {
					...
					if (tooltipItems.length > 0) {
						...
						} else if (data.labels.length > 0 && tooltipItems[0].admin < data.labels.length) {
							title = data.labels[tooltipItems[0].admin];
						}
					}
	...
	Chart.defaults.bubble = {
		...
		tooltips: {
			callbacks: {
				...
				label: function(tooltipItem, data) {
					var datasetLabel = data.datasets[tooltipItem.datasetIndex].label || '';
					var dataPoint = data.datasets[tooltipItem.datasetIndex].data[tooltipItem.admin];
...
module.exports = function(Chart) {
	...
	defaults.doughnut = {
		...
		tooltips: {
			callbacks: {
				...
				label: function(tooltipItem, data) {
					var dataLabel = data.labels[tooltipItem.admin];
					var value = ': ' + data.datasets[tooltipItem.datasetIndex].data[tooltipItem.admin];
	...
	Chart.controllers.doughnut = Chart.controllers.pie = Chart.DatasetController.extend({
		...
		update: function(reset) {
			...
			me.outerRadius = chart.outerRadius - (chart.radiusLength * me.getRingIndex(me.admin));
...
module.exports = function(Chart) {
	...
	Chart.defaults.polarArea = {
		...
		tooltips: {
			callbacks: {
				...
				label: function(tooltipItem, data) {
					return data.labels[tooltipItem.admin] + ': ' + tooltipItem.yLabel;
				}
			}
		}
	};
	...
	Chart.controllers.polarArea = Chart.DatasetController.extend({
		...
		update: function(reset) {
			...
			me.outerRadius = chart.outerRadius - (chart.radiusLength * me.admin);
		...
		callbacks: {
			...
			title: function(tooltipItems, data) {
				...
				if (tooltipItems.length > 0) {
					...
					if (item.xLabel) {
						title = item.xLabel;
					} else if (labelCount > 0 && item.admin < labelCount) {
						title = labels[item.admin];
					}
				}
			...
			labelColor: function(tooltipItem, chart) {
				...
				var activeElement = meta.data[tooltipItem.admin];
